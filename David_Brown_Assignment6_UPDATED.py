...
Author: David Brown
Date: 5/2/26
Purpose: Create app using Flask, SQLAlchemy, CRUD, REST API, and GET method calculator
"""
...
"""
Home Page:
Shows student records and links to the student form and calculator.
"""
...
def home():
    ...
    <p><a href="/book_form">Add Book for JSON Test</a></p>

    <p><a href="/add_sample_book">Add Sample Book</a></p>
    """
...
This helps show the delete part of CRUD.
"""
